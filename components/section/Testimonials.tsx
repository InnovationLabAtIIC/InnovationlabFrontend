                                ...
                                >
                                    ...
                                    >
                                        <div className={`absolute -top-10 left-6 w-20 h-20 ${t.avatarBg} flex items-center justify-center`}>
                                            <Image fill src={t.image} alt={t.name} className="w-full h-full object-cover translate-x-2 -translate-y-2 md:translate-x-4 md:-translate-y-4" />
                                        </div>
                    ...
                    {TESTIMONIALS.map((t, idx) => (
                        ...
                        >
                            <div className={`absolute -top-10 md:-top-14 left-6 w-20 h-20 md:w-28 md:h-28 ${t.avatarBg} flex items-center justify-center`}>
                                <Image fill src={t.image} alt={t.name} className="w-full h-full object-cover translate-x-4 -translate-y-4" />
                            </div>
